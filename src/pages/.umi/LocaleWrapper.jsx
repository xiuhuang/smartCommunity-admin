...
const localeInfo = {
  'en-US': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/grandhonor/grandhonor/smartCommunity-admin/src/pages/dashboard/analysis/locales/en-US.ts')),
    },
    locale: 'en-US',
  ...
  'pt-BR': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/grandhonor/grandhonor/smartCommunity-admin/src/pages/dashboard/analysis/locales/pt-BR.ts')),
    },
    locale: 'pt-BR',
  ...
  'zh-CN': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/grandhonor/grandhonor/smartCommunity-admin/src/pages/dashboard/analysis/locales/zh-CN.ts')),
    },
    locale: 'zh-CN',
  ...
  'zh-TW': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/grandhonor/grandhonor/smartCommunity-admin/src/pages/dashboard/analysis/locales/zh-TW.ts')),
    },
    locale: 'zh-TW',
