    ...
    return (
      <table className={styles.table}>
        <tr>
          ...
          <th>性别</th>
          <td>
            {residentInfo.baseInfo.sex === '0' && <span>男</span>}
            {residentInfo.baseInfo.sex === '1' && <span>女</span>}
            {residentInfo.baseInfo.sex === '2' && <span>未知</span>}
        ...
        <tr>
          <th>住户号:</th>
          <td colSpan={3}>{residentInfo.baseInfo.houseName || '--'}</td>
        </tr>
      </table>
    );
  }
