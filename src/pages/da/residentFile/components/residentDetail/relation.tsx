...
// import G6 from '@antv/g6';
const G6: any = require('@antv/g6');

interface RelationProps {
  data?: any;
}

class Relation extends Component<RelationProps> {
  state = {};
      ...
      'circle-animate',
      {
        afterDraw: function afterDraw(cfg: any, group: any) {
          ...
          shape.animate(
            {
              repeat: true,
              onFrame: function onFrame(ratio: any) {
  ...
  render() {
    return <div id="mountNode" style={{ width: '100%', height: 360 }}></div>;
  }
}
