...
interface SmokeListProps extends FormComponentProps {
...
@connect(
  ({
    ...
    smoke,
    loading: loading.models.smoke,
  }),
)
class SmokeList extends Component<SmokeListProps> {
  state = {
    selectedRows: [],
  };
  ...
  render() {
    const { loading, smoke } = this.props;
...
export default Form.create<SmokeListProps>()(SmokeList);
