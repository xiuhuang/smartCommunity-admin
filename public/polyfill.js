...
})()(
  {
    ...
    141: [
      function(_dereq_, module, exports) {
        ...
        $export(
          $export.P + $export.F * (_dereq_(53) != Object || !_dereq_(104)(arrayJoin)),
          'Array',
          {
            join: function join(separator) {
      ...
      function(_dereq_, module, exports) {
        ...
        var USE_NATIVE = !!(function() {
          try {
            ...
            var FakePromise = ((promise.constructor = {})[_dereq_(128)('species')] = function(
              exec,
            ) {
              exec(empty, empty);
            });
    ...
    254: [
      function(_dereq_, module, exports) {
        ...
        $Symbol[PROTOTYPE][TO_PRIMITIVE] ||
          _dereq_(48)($Symbol[PROTOTYPE], TO_PRIMITIVE, $Symbol[PROTOTYPE].valueOf);
    ...
    273: [
      function(_dereq_, module, exports) {
        ...
        $export(
          $export.P + $export.F * /Version\/10\.\d+(\.\d+)? Safari\//.test(userAgent),
          'String',
          {
